...
################################################################################
## Form generated from reading UI file 'MotionClientdUNAIX.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.USBtoSerialBox.setGeometry(QRect(270, 50, 250, 270))
        ...
        self.PushButton_PortConnect.setGeometry(QRect(40, 70, 80, 22))
        ...
        self.PushButton_PortDisconnect.setGeometry(QRect(140, 70, 80, 22))
        self.ComboBox_SerialPort = QComboBox(self.USBtoSerialBox)
        self.ComboBox_SerialPort.setObjectName(u"ComboBox_SerialPort")
        self.ComboBox_SerialPort.setGeometry(QRect(40, 30, 180, 30))
        self.flowControlLabel = QLabel(self.USBtoSerialBox)
        self.flowControlLabel.setObjectName(u"flowControlLabel")
        self.flowControlLabel.setGeometry(QRect(40, 240, 77, 22))
        self.baudRateBox = QComboBox(self.USBtoSerialBox)
        self.baudRateBox.setObjectName(u"baudRateBox")
        self.baudRateBox.setGeometry(QRect(140, 124, 79, 22))
        self.dataBitsBox = QComboBox(self.USBtoSerialBox)
        self.dataBitsBox.setObjectName(u"dataBitsBox")
        self.dataBitsBox.setGeometry(QRect(140, 153, 79, 22))
        self.flowControlBox = QComboBox(self.USBtoSerialBox)
        self.flowControlBox.setObjectName(u"flowControlBox")
        self.flowControlBox.setGeometry(QRect(140, 240, 79, 22))
        self.parityBox = QComboBox(self.USBtoSerialBox)
        self.parityBox.setObjectName(u"parityBox")
        self.parityBox.setGeometry(QRect(140, 182, 79, 22))
        self.dataBitsLabel = QLabel(self.USBtoSerialBox)
        self.dataBitsLabel.setObjectName(u"dataBitsLabel")
        self.dataBitsLabel.setGeometry(QRect(40, 153, 77, 22))
        self.stopBitsLabel = QLabel(self.USBtoSerialBox)
        self.stopBitsLabel.setObjectName(u"stopBitsLabel")
        self.stopBitsLabel.setGeometry(QRect(40, 211, 77, 22))
        self.stopBitsBox = QComboBox(self.USBtoSerialBox)
        self.stopBitsBox.setObjectName(u"stopBitsBox")
        self.stopBitsBox.setGeometry(QRect(140, 211, 79, 22))
        self.parityLabel = QLabel(self.USBtoSerialBox)
        self.parityLabel.setObjectName(u"parityLabel")
        self.parityLabel.setGeometry(QRect(40, 182, 77, 22))
        self.baudRateLabel = QLabel(self.USBtoSerialBox)
        self.baudRateLabel.setObjectName(u"baudRateLabel")
        self.baudRateLabel.setGeometry(QRect(40, 124, 77, 22))
        self.Label_ConnectionStatus = QLabel(self.USBtoSerialBox)
        self.Label_ConnectionStatus.setObjectName(u"Label_ConnectionStatus")
        self.Label_ConnectionStatus.setGeometry(QRect(40, 100, 180, 22))
        ...
        self.groupBox_6.setGeometry(QRect(10, 698, 511, 81))
        ...
        self.console = QPlainTextEdit(MainWindow)
        self.console.setObjectName(u"console")
        self.console.setGeometry(QRect(10, 570, 510, 120))
